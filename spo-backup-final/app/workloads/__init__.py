...
WORKLOAD_META = {
    "sharepoint": {
        ...
        "backup_scope": "Discovers SharePoint sites from Microsoft Graph and syncs selected sites into the backup site registry automatically.",
        "selection_label": "Choose discovered sites here to add or re-enable them for SharePoint backup without manual path entry.",
        "manage_href": "/sites",
